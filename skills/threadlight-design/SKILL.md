...
> the one-line callout in SPEC § 12. In **Full mode**, walk the operator through
...
> (deployment posture), and **§ 12** (runtime / observability) from it instead
...
(from-scratch path) and pre-populate SPEC § 7b / § 11c / § 11e / § 11f / § 12
