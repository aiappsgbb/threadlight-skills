...
and a matching signed `confirmation_requirement`. Use the separate
`threadlight-confirm-action` client and the
...
workload identity. Basic email notifies, it is not MFA. Entra context assurance
