...
*Generated by `threadlight-production-ready` v0.3.0 at 2026-06-10T16:57:40Z*
...
| 8. HITL and audit | 🔴 red | 🔴 red | 25% | 25% |
...
25. **HITL-005** — HITL decision SLA documented. See: `threadlight-hitl-patterns`
26. **IAM-003** — RBAC scopes declared in Bicep (not subscription-wide). See: `foundry-hosted-agents`, `azure-tenant-isolation`
27. **IAM-005** — ACA / Functions auth enabled. See: `foundry-hosted-agents`, `azure-tenant-isolation`
28. **MDL-002** — Deprecation plan referenced in SPEC. See: `foundry-skill-catalog`, `foundry-evals`
29. **MDL-005** — Fallback model strategy documented. See: `foundry-skill-catalog`, `foundry-evals`
30. **MDL-006** — Rate limit handling in code. See: `foundry-skill-catalog`, `foundry-evals`
31. **MDL-007** — Region-residency policy for models. See: `foundry-skill-catalog`, `foundry-evals`
...
33. **OBS-004** — Foundry observability emit configured. See: `foundry-observability`
...
41. **SUP-001** — Container images pinned by digest. See: `azd-patterns`
42. **SUP-005** — Vulnerability scan step declared. See: `azd-patterns`
