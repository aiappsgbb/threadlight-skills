...
```bash
npx playwright test tests/governed-learning-path.spec.mjs tests/governed-workflow.spec.mjs tests/governed-page-integration.spec.mjs tests/native-outlook-page.spec.mjs
```
