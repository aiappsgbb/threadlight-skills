// Extension: threadlight-lifecycle
// Threadlight lifecycle canvas extension
//
...
function renderHtml(instanceId) {
    return `<!doctype html>
<html>
  <head><meta charset="utf-8" /><title>threadlight-lifecycle</title></head>
  <body style="font-family: system-ui; padding: 1rem;">
    <h1>threadlight-lifecycle</h1>
